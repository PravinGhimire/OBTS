      ...
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle" align="center">
            <i class="glyphicon glyphicon-log-in">Add New source</i></h2>
        ...
        <form method="post" action="{{ route('source.store') }}" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                                ...
                                <input name="source_name"  class="form-control" aria-describedby="emailHelp"
                                 placeholder="Enter source Name" type="text">
                          </div>
                          </div>
                          <div class="col-md-6">
                          <div class="form-group">
                                <!-- <label for="exampleInputEmail1">Bus Name</label> -->
                                <input name="source_code"  class="form-control" aria-describedby="emailHelp" 
                                placeholder="Enter source Code" type="text">
                          </div>
                          </div>
                          </div>
                          <div class="col-md-3">
